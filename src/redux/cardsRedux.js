...
const reducerNameMoveCard = 'moveCard';
const createActionNameMoveCard = name => `app/${reducerNameMoveCard}/${name}`;

// action types
export const ADD_CARD = createActionName('ADD_CARD');
export const MOVE_CARD = createActionNameMoveCard('MOVE_CARD');
